...
export class dev1624185779972 implements MigrationInterface {
    name = 'dev1624185779972'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "messages" ("id" SERIAL NOT NULL, "content" character varying NOT NULL, "isRead" boolean NOT NULL, "timeStamp" date NOT NULL, "chatId" integer, "senderId" integer, "recipientId" integer, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
